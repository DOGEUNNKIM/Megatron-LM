...
# Add Megatron-LM root to sys.path (this file lives in examples/gemma4/)
...
def _build_megatron_argv(ckpt, tp=2, bf16=False):
    return [
        ...
        "--spec", "megatron.core.models.gpt.gemma4_layer_specs", "gemma4_layer_spec",
...
def main():
    ...
    if not os.path.isfile("pretrain_gpt.py"):
        sys.exit("Error: run from the Megatron-LM root directory.")
